...
frame sumres{
	twoway ///
		...
		title("{bf:Prevalence heterogeneity}", size(med)) ///
...
twoway ///
    ...
    , ///
    ytitle("Coverage (%)", size(small )) xtitle("{&tau}{sub:{&pi}}", size(small)) ///
...
frame sumres{
	twoway ///
		...
		, ///
		yline(1, lcolor(black) lpattern(dash)) ///
		xtitle("{&tau}{sub:a} & {&tau}{sub:c}", size(small)) ///
		ytitle("{&theta}{sub:1}", size(small)) ///
		ylabel(, labsize(small) format(%3.2f) nogrid) ///
		xlabel(#6, labsize(small) nogrid format(%3.2f)) ///
		legend(order(11 "Ref" 7 "CCA" 15 "No adjustment" 3 "MI") ///
			   pos(6) ring(0) cols(4) size(small)) ///
		title("{bf:Confounding path heterogeneity}", size(med)) ///
		graphregion(color(white))  name(bias_b1, replace)
}
...
twoway ///
    ...
    (line coverage tau if beta=="b1_true", lcolor(gold)) ///
    , ///
    ytitle("Coverage (%)", size(small )) xtitle("{&tau}{sub:a} & {&tau}{sub:c}", size(small)) ///
	yscale(range(0 105)) ylabel(0(10)100, labsize(small) nogrid) ///
	xlab(#6, labsize(small) nogrid format(%3.2f)) ///
    yline(95, lpattern(dash) lwidth(thin) lcolor(gs8)) ///
    legend(order(7 "Ref" 1 "CCA" 5 "No adjustment" 3 "MI") ///
...
frame sumres{
	twoway ///
		...
		, ///
		yline(1, lcolor(black) lpattern(dash)) ///
		xtitle("{&tau}{sub:b}", size(small)) ///
		ytitle("{&theta}{sub:1}", size(small)) ///
		ylabel(, labsize(small) format(%3.2f) nogrid) ///
		xlabel(#6, labsize(small) nogrid format(%3.2f)) ///
		legend(order(11 "Ref" 7 "CCA" 15 "No adjustment" 3 "MI") ///
			   pos(6) ring(0) cols(4) size(small)) ///
		title("{bf:Effect heterogeneity}", size(med)) ///
		graphregion(color(white))  name(bias_b1, replace)
}
...
twoway ///
    ...
    (line coverage tau if beta=="b1_true", lcolor(gold)) ///
    , ///
    ytitle("Coverage (%)", size(small )) xtitle("{&tau}{sub:b}", size(small)) ///
	yscale(range(0 105)) ylabel(0(10)100, labsize(small) nogrid) ///
	xlab(#6, labsize(small) nogrid format(%3.2f)) ///
    yline(95, lpattern(dash) lwidth(thin) lcolor(gs8)) ///
    legend(order(7 "Ref" 1 "CCA" 5 "No adjustment" 3 "MI") ///
...
frame sumres{
	twoway ///
		...
		, ///
		yline(1, lcolor(black) lpattern(dash)) ///
		xtitle("{&tau}", size(small)) ///
		ytitle("{&theta}{sub:1}", size(small)) ///
		ylabel(, labsize(small) format(%3.2f) nogrid) ///
		xlabel(#6, labsize(small) nogrid format(%3.2f)) ///
		legend(order(11 "Ref" 7 "CCA" 15 "No adjustment" 3 "MI") ///
			   pos(6) ring(0) cols(4) size(small)) ///
		title("{bf:Heterogeneity}", size(med)) ///
		graphregion(color(white))  name(bias_b1, replace)
}
...
twoway ///
    ...
    (line coverage tau if beta=="b1_true", lcolor(gold)) ///
    , ///
    ytitle("Coverage (%)", size(small )) xtitle("{&tau}", size(small)) ///
	yscale(range(0 105)) ylabel(0(10)100, labsize(small) nogrid) ///
	xlab(#6, labsize(small) nogrid format(%3.2f)) ///
    yline(95, lpattern(dash) lwidth(thin) lcolor(gs8)) ///
    legend(order(7 "Ref" 1 "CCA" 5 "No adjustment" 3 "MI") ///
