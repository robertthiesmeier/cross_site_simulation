...
program define scenario, rclass
	...
	syntax [, a1(real 1) c1(real 1) tau_a(real 0) tau_pi(real 0) tau_b(real 0) tau_c(real 0) tau_alpha(real 0)]
	drop _all 
	...
	dgm, a1(`a1') c1(`c1') tau_a(`tau_a') tau_pi(`tau_pi') tau_b(`tau_b') tau_c(`tau_c') tau_alpha(`tau_alpha')
...
forv k = 0(0.5)3{
	simulate ///
		...
		,reps($nsim ): scenario, a1(`k') c1(`k') tau_a(0.3) tau_b(0.3) tau_c(0.3) tau_pi(0.3) tau_alpha(0.3)
		
	save "data/data_sim_scenario_3_4_`k'.dta", replace
}
