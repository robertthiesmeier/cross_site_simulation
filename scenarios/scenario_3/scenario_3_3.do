...
program define scenario, rclass
	...
	syntax [, c1(real 1) tau_b(real 0) tau_a(real 0) tau_c(real 0) tau_pi(real 0) tau_alpha(real 0)]
	drop _all 
	...
	dgm, c1(`c1') tau_b(`tau_b') tau_a(`tau_a') tau_c(`tau_c') tau_pi(`tau_pi') tau_alpha(`tau_alpha')
...
forv k = 0(0.5)3{
	simulate ///
		...
		,reps($nsim ): scenario, c1(`k') tau_b(0.3) tau_a(0.3) tau_c(0.3) tau_pi(0.3) tau_alpha(0.3)
		
	save "data/data_sim_scenario_3_3_`k'.dta", replace
}
