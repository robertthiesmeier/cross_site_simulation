...
program define scenario, rclass
	...
	syntax [, pi1(real 0.3) tau_pi(real 0) tau_a(real 0) ///
			tau_b(real 0) tau_c(real 0) tau_alpha(real 0)]
	...
	dgm, pi1(`pi1') tau_pi(`tau_pi') tau_alpha(`tau_alpha') tau_a(`tau_a') tau_b(`tau_b') tau_c(`tau_c') 
...
forv k = 0.1(0.1)0.6{
	simulate ///
		...
		,reps($nsim ): scenario, pi1(`k') tau_pi(0.3) tau_a(0.3) tau_b(0.3) tau_c(0.3) tau_alpha(0.3)
		
	save "data/data_sim_scenario_3_1_`k'.dta", replace
}
