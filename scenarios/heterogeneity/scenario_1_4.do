...
program define het_scenario, rclass
	...
	syntax [, tau_pi(real 0) tau_a(real 0) tau_b(real 0) tau_c(real 0) ]
	...
	dgm,  tau_pi(`tau_pi') tau_a(`tau_a') tau_b(`tau_b') tau_c(`tau_c')
	...
	*frame random_impmodel: list 
	...
	frame random_impmodel: meta mvregress y* , ///
		wcovvariables(v*) random(reml, covariance(identity))
...
forv k = 0(0.05)0.3{
	simulate ///
		...
		,reps($nsim  ): het_scenario, tau_pi(`k') tau_a(`k') tau_b(`k') tau_c(`k')
