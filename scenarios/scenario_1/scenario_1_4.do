...
program define het_scenario, rclass
	...
	syntax [, tau_pi(real 0) tau_a(real 0) tau_b(real 0) tau_c(real 0) tau_alpha(real 0) ]
	...
	dgm,  tau_pi(`tau_pi') tau_a(`tau_a') tau_b(`tau_b') tau_c(`tau_c') tau_alpha(`tau_alpha')
...
forv k = 0(0.1)0.6{
	simulate ///
		...
		,reps($nsim  ): het_scenario, tau_pi(`k') tau_a(`k') tau_b(`k') tau_c(`k') tau_alpha(`k')
	
	save "data/het_scenario_1_4_`k'.dta", replace
}
