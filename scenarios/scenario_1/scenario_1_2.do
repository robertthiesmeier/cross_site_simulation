...
*** confounding path heterogenity (tau_a and tau_c)
...
program define het_scenario, rclass
	...
	syntax [, tau_a(real 0) tau_c(real 0) ]
...
forv k = 0(0.1)0.6{
	simulate ///
		...
		,reps($nsim  ): het_scenario, tau_a(`k') tau_c(`k')
	
	save "data/het_scenario_1_2_`k'.dta", replace
}
